...
/*package*/ class DataDictionary_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_r8s0uu_a5a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, MetaAdapterFactory.getContainmentLink(0x16d63821a9174aafL, 0xa85f305cd4a0013fL, 0x73ede05be9bfff49L, 0x3ca44af6d3198070L, "semanticDomenDefinitions"))).count() > 0;
  }
  ...
  private EditorCell createConstant_6() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Semantic domen definitions");
    editorCell.setCellId("Constant_r8s0uu_b5a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new DataDictionary_EditorBuilder_a.semanticDomenDefinitionsListHandler_r8s0uu_c5a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_semanticDomenDefinitions");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class semanticDomenDefinitionsListHandler_r8s0uu_c5a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public semanticDomenDefinitionsListHandler_r8s0uu_c5a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(semanticDomenDefinitionsListHandler_r8s0uu_c5a.this.getNode(), MetaAdapterFactory.getContainmentLink(0x16d63821a9174aafL, 0xa85f305cd4a0013fL, 0x73ede05be9bfff49L, 0x3ca44af6d3198070L, "semanticDomenDefinitions")));
      try {

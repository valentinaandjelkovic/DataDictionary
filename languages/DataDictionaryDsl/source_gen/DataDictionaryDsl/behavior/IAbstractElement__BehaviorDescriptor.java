...
public final class IAbstractElement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> generateFieldDefinition_id6O3$yg35ULU = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("generateFieldDefinition").modifiers(SModifiersImpl.create(12, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("6O3$yg35ULU").registry(REGISTRY).build(SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), ""));
